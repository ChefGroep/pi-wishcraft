...
- [Configuration](./configuration.md) — custom items, hooks, repairs, token budget, welcome lantern, powerline keyword motion, labels, templates, layout, cost alert, and display formats.
